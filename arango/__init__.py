...
class Arango(object):
    ...
    def __init__(self, protocol='http', host='localhost', port=8529,
        ...
        """Initialize the ArangoDB API driver.
    ...
    def __repr__(self):
        ...
        return "<ArangoDB API driver for '{}'>".format(self._host)
    ...
    def server_statistics(self, description=False):
    ...
    def set_wal_options(self, oversized_ops=None, log_size=None,
    ...
    def flush_wal(self, sync=True, garbage_collect=True):
